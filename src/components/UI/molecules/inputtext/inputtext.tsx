...
const InputTextComponent: React.FC<any> = (props) => {
    ...
    <>
        ...
        <div className='select'>
        <Select  name='start_t' placeholder='없음' item={time}></Select>
        </div>
        시
        <div className='select'>
        <Select name='start_m' placeholder='없음' item={minute}></Select>
        </div>
        분
        </>
        ...
        <Select  name='end_t' placeholder='없음' item={time}></Select>
        </div>
        시
        <div className='select'>
        <Select  name='end_m' placeholder='없음' item={minute}></Select>
        </div>
        분
        </>:''}
